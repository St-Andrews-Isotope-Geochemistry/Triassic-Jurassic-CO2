...
writematrix(string(d18O_d13C.Properties.VariableNames),current_file,"Sheet","Temperature_Calibrations","Range","A1");
writematrix(["m","Ma","‰","‰","°C","°C","°C","°C"],current_file,"Sheet","Temperature_Calibrations","Range","A2");
writematrix(d18O_d13C{:,:},current_file,"Sheet","Temperature_Calibrations","Range","A3");
...
%% Delta temperature
delta_temperature = averaged.hansen_temperature-averaged.hansen_temperature(1);
