...
% intermediate_file = jsondecode(fileread(data_directory+"/pH_change/intermediate.json"));
posterior_file = jsondecode(fileread(data_directory+"/pH_change/posterior_smoother.json"));
...
%% Save to file
filename = data_directory+"/pH_Change/posterior_smoother_metrics.xlsx";
