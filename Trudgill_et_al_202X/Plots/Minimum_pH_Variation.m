...
clf
ca_axis = axes();
plot(independent("calcium"),pH_difference("calcium"),'Color',colours("calcium"),'LineWidth',2,'Parent',ca_axis);
...
set(current_label,'Position',[max(independent("calcium"))*1.02,12],'HorizontalAlignment','Left');
xlim([min(independent("calcium")),max(independent("calcium"))]);


mg_xaxis = axes('Position',(new_position.*[1,1,1,1e-3])+[0,-0.06,0,0],'Color','None');
...
set(current_label,'Position',[max(independent("magnesium"))*1.02,12],'HorizontalAlignment','Left');
xlim([min(independent("magnesium")),max(independent("magnesium"))]);

temperature_change_xaxis = axes('Position',(new_position.*[1,1,1,1e-3])+[0,-0.12,0,0],'Color','None');
...
set(current_label,'Position',[max(independent("temperature_change"))*1.02,12],'HorizontalAlignment','Left');
xlim([min(independent("temperature_change")),max(independent("temperature_change"))]);

initial_temperature_xaxis =axes('Position',(new_position.*[1,1,1,1e-3])+[0,new_position(4)+0,0,0],'Color','None','XAxisLocation','Top');
...
set(current_label,'Position',[max(independent("initial_temperature"))*1.02,-12],'HorizontalAlignment','Left');
xlim([min(independent("initial_temperature")),max(independent("initial_temperature"))]);

saturation_state_xaxis = axes('Position',(new_position.*[1,1,1,1e-3])+[0,new_position(4)+0.06,0,0],'Color','None','XAxisLocation','Top');
...
set(current_label,'Position',[max(independent("saturation_state"))*1.005,-12],'HorizontalAlignment','Left');
xlim([min(independent("saturation_state")),max(independent("saturation_state"))]);

co2_xaxis = axes('Position',(new_position.*[1,1,1,1e-3])+[0,new_position(4)+0+0.12,0,0],'Color','None','XAxisLocation','Top');
...
set(current_label,'Position',[max(independent("co2"))*1e6*1.02,-12],'HorizontalAlignment','Left');
